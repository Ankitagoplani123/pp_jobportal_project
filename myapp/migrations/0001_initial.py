# Generated by Django 3.1.3 on 2022-04-14 14:19
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('experience_details', models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='myapp.experiencedetails')),
            ],
        ),
        migrations.CreateModel(
            name='CompanyDetails',
            fields=[
                ...
                ('job_skill_set', models.ManyToManyField(blank=True, null=True, to='myapp.JobSkillSet')),
            ],
        ),
    ]
